...
import static com.ofg.infrastructure.Jsons.*
import static StubRunnerPlugin.getEXTENSION_NAME
import static com.ofg.infrastructure.UrlEspaceUtils.escape
...
class UptodatePluginSpec extends WireMockSpec {
    ...
    private void executeUptodateTask() {
        project.tasks.getByName(EXTENSION_NAME).execute()
    }
